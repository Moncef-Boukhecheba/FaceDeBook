...
<!DOCTYPE html><html class=''>
  <head><script src='//production-assets.codepen.io/assets/editor/live/console_runner-079c09a0e3b9ff743e39ee2d5637b9216b3545af0de366d4b9aad9dc87e26bfd.js'></script><script src='//production-assets.codepen.io/assets/editor/live/events_runner-73716630c22bbc8cff4bd0f07b135f00a0bdc5d14629260c3ec49e5606f98fdd.js'></script><script src='//production-assets.codepen.io/assets/editor/live/css_live_reload_init-2c0dc5167d60a5af3ee189d570b1835129687ea2a61bee3513dee3a50c115a77.js'></script><meta charset='UTF-8'><meta name="robots" content="noindex"><link rel="shortcut icon" type="image/x-icon" href="//production-assets.codepen.io/assets/favicon/favicon-8ea04875e70c4b0bb41da869e81236e54394d63638a1ef12fa558a4a835f1164.ico" /><link rel="mask-icon" type="" href="//production-assets.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" /><link rel="canonical" href="https://codepen.io/Reklino/pen/xbaKJJ?depth=everything&limit=all&order=popularity&page=3&q=code+editor&show_forks=false" />
    <link rel="stylesheet" href="https://cdn.rawgit.com/Reklino/strings/master/strings.css">
    <script src="//use.typekit.net/cua2obb.js"></script>
    <script>try{Typekit.load();}catch(e){}</script>
    <link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css'>
    <style class="cp-pen-styles">.col-1 {
      ...
      .dark .icon-tab:before {
        background: #39415a;
      }
      .dark .icon-tab .label {
        color: #566389;
      }
      .dark .icon-tab:hover .label {
        color: #FFFFFF;
      }
      .dark .icon-tab.active .s {
        color: white;
      }
      .dark .icon-tab.active:before {
        background: #56cd88;
      }
      .dark .icon-tab.active .label {
        color: #FFFFFF;
      }

      .col-3:nth-child(1) .icon-tab.active:before {
        background: #4ddfdc;
      }

      .col-3:nth-child(2) .icon-tab.active:before {
        background: #50ecbd;
      }

      .col-3:nth-child(3) .icon-tab.active:before {
        background: #56cd88;
      }

      .col-3:nth-child(4) .icon-tab.active:before {
        background: #4dd85d;
      }
    </style></head><body>
  <?php
  ...
  <body class='dark'>
    <nav>
      ...
      <div class='s s-sun' id='light-switch'>BDE</div>

      <div class='name'><img src="images/man2.png" class="img-responsive" alt=""/>
      </div>
    </nav>
    <section>
      <div class='container align-center'>
        <div class='col-12'>
          <div class='icon-tab'>
            <div class='s s-sun' id='light-switch'></div>
            <img src="images/logo-CESI.png" onclick="window.location.href='google.com'" class="img-responsive" alt=""/>
          </div>
        </div>
        <div class='col-4'>
          <div class='icon-tab'>
            <div class='s s-image' onclick="myfunction();"></div>
            <div class='label' >Produit</div>
          </div>
        </div>
        <div class='col-4'>
          <div class='icon-tab'>
            <div class='s s-image'  onclick="window.location.href='gestionevenement.php'"></div>
            <div class='label'>Evenements</div>
          </div>
        </div>
        <div class='col-4'>
          <div class='icon-tab'>
            <div class='s s-layout'  onclick="window.location.href='gestioninscription.php'"></div>
    ...
    <div class=" targetDiv container" id="myDIV">
    ...
    <script src='//production-assets.codepen.io/assets/common/stopExecutionOnTimeout-b2a7b3fe212eaa732349046d8416e00a9dec26eb7fd347590fbced3ab38af52e.js'></script><script src='https://cdn.rawgit.com/desandro/classie/master/classie.js'></script><script src='https://codepen.io/Reklino/pen/RNYNaZ.js'></script>
  </body></html>